...
const {msg} = alerta
  ...
  return (
    <>
        ...
        <div>
            <h1 className='text-indigo-600 font-black text-6xl'>Restablece tu {""} <span className='text-black'>contraseña</span></h1>
        </div>
            ...
            {tokenValido &&(
                ...
                <>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='my-5'>
                            <label className=' text-gray-600 block text-xl font-bold'>Nueva Contraseña</label>
                            <input type="password" 
